...
function Popup() {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "h-[400px] w-[300px] p-4" },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", { type: "text", value: inputUrl, onChange: (e) => setInputUrl(e.target.value), placeholder: "Enter LinkedIn URL", className: "border p-2 w-full mt-4" }),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { onClick: handleScrape, className: "px-4 py-2 bg-blue-600 text-white w-full mt-2" }, "Scrape LinkedIn Profile"),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", { className: "text-[16px] mt-4" }, "Saved Profiles:"),
        profiles === null ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Loading...")) : profiles.length === 0 ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "No profiles saved yet.")) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", null, profiles.map((p, i) => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", { key: i },
            ...
            " ",
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br", null),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", { href: p.url, target: "_blank", rel: "noreferrer" }, p.url),
